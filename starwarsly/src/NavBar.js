/**
 * This component represents the navigation bar of the application that allows users to navigate between different sections, such as films, planets, and people.
 */
